...
test_outputs=shuffle_df['category']

# val_outputs=val['category']


test_inputs=shuffle_df[['left_shoulder_x','left_shoulder_y','right_shoulder_x','right_shoulder_y','lef_hip_x','lef_hip_y','right_hip_x','right_hip_y',
